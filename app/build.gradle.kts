...
android {
    namespace = "com.example.appvacaciones"
    compileSdk = 34

    defaultConfig {
        applicationId = "com.example.appvacaciones"
        minSdk = 24
        targetSdk = 34
        versionCode = 1
        versionName = "1.0"
...
dependencies {
    ...
    implementation("androidx.compose.material3:material3:1.1.1")//version estable de material3
